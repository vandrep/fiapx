...
| **Modelar ameaças** — ativos, fronteiras de confiança, abuso e mitigação | [`../requisitos/historias.md`](../requisitos/historias.md), [`../requisitos/glossario.md`](../requisitos/glossario.md), [`../arquitetura/caracteristicas.md`](../arquitetura/caracteristicas.md) e [`../arquitetura/componentes-coesos.md`](../arquitetura/componentes-coesos.md) | Um contrato, quantum ou tecnologia aceita introduzir uma superfície concreta; carregue somente a decisão ou o código correspondente |
